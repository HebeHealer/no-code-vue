<template>
  <div class="app-left-panel-wrapper">
    <div class="app-left-panel-bar" :style="{ boxShadow: 'var(--color-gary-300) 1px 0px 0px' }">
      <div
...
const toggleDrawer = (drawerNode: DrawerMode = null) => {
  if (isDrawerShown.value === drawerNode) {
    isDrawerShown.value = null
    return
  }
  isDrawerShown.value = drawerNode
}
</script>
